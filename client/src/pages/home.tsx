    ...
    <div className="min-h-screen">
      ...
      <header className="relative py-8 text-center">
        ...
        <div className="relative z-10">
          ...
          <p className="text-black text-xl md:text-4xl font-fredoka max-w-2xl mx-auto px-4 mt-2">
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="mt-16 text-center">
          <h3 className="font-fredoka text-4xl text-black mb-8">Why Choose DreamTales?</h3>
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 max-w-4xl mx-auto">
            <div className="bg-cloud-white backdrop-blur-sm rounded-2xl rainbow-title p-6 shadow-lg border border-black">
      ...
      {/* Footer */}
      <footer className="bg-white/10 backdrop-blur-sm py-8 mt-6 ">
        <div className="container mx-auto px-4 text-center">
          <p className="text-black text-1xl ">© 2024 DreamTales. Creating magical bedtime stories for children everywhere. ✨</p>
        </div>
      </footer>
    </div>
  );
